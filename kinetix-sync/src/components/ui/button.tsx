  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-white shadow-lg hover:shadow-xl hover-lift hover-glow border-0",
        success: "bg-success text-success-foreground hover:bg-success/90 hover-lift",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90",
        glass: "glass-card text-card-foreground hover:bg-accent/50 hover-lift",
        gradient: "bg-gradient-hero text-white shadow-lg hover:shadow-xl hover-lift animate-pulse-glow",
      },
      size: {
